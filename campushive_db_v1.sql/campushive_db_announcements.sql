...
CREATE TABLE `announcements` (
  ...
  `attachment_type` enum('NONE','IMAGE','PDF','LINK') DEFAULT 'NONE',
  ...
  CONSTRAINT `announcements_ibfk_1` FOREIGN KEY (`organization_id`) REFERENCES `organizations` (`organization_id`),
